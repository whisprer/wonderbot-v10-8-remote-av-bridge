            ...
            if config.remote_bridge.enabled and config.remote_bridge.camera_enabled:
                adapters.append(
                    RemoteCameraAdapter(
                        ...
                        vision_lite_enabled=config.camera.vision_lite_enabled,
                        analysis_width=config.camera.vision_lite_analysis_width,
                        motion_pixel_threshold=config.camera.vision_lite_motion_pixel_threshold,
                        scene_change_threshold=config.camera.vision_lite_scene_change_threshold,
                        backend_min_salience=config.camera.vision_lite_backend_min_salience,
                        sharpness_reference=config.camera.vision_lite_sharpness_reference,
                        face_hint_enabled=config.camera.vision_lite_face_hint_enabled,
                        face_hint_min_interval_seconds=config.camera.vision_lite_face_hint_min_interval_seconds,
                        expression_hint_enabled=config.camera.vision_lite_expression_hint_enabled,
                        expression_hint_min_interval_seconds=config.camera.vision_lite_expression_hint_min_interval_seconds,
                        expression_hint_min_face_confidence=config.camera.vision_lite_expression_hint_min_face_confidence,
                        state_change_cooldown_seconds=config.camera.vision_lite_state_change_cooldown_seconds,
                        captioner=captioner,
